...
.venv/bin/python scripts/transcribe.py --device cuda --start 188 --duration 60 --output outputs/gpu-sample
.venv/bin/python scripts/align.py --device cuda --output outputs/gpu-sample
